    ...
    return (
        ...
        >
            <div
                id={`${id}-title`}
                aria-hidden="true"
                className="text-sm font-medium text-slate-900 group-aria-selected:text-sky-500 dark:text-white"
            >
        ...
        <div className="group relative flex h-12">
            ...
            {autocompleteState.status === 'stalled' && (
                <div className="absolute inset-y-0 right-3 flex items-center">
                    <LoadingIcon
                        className="h-5 w-5 animate-spin stroke-slate-200 text-slate-900 dark:stroke-slate-800 dark:text-sky-400"/>
                </div>
            )}
        </div>
    )
        ...
        >
            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
                    ...
                    >
                        <Dialog.Panel
                            className="mx-auto overflow-hidden rounded-lg bg-slate-50 shadow-xl ring-1 ring-slate-900/7.5 dark:bg-slate-900 dark:ring-slate-800 sm:max-w-xl">
