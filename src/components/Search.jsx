                ...
                queries: [
                  {
                    ...
                    params: {
                      hitsPerPage: 5,
                      highlightPreTag:
                        '<mark class="underline bg-transparent text-sky-500">',
    ...
    <div className="group relative flex h-12">
      ...
      {autocompleteState.status === 'stalled' && (
        <div className="absolute inset-y-0 right-3 flex items-center">
          <LoadingIcon className="h-5 w-5 animate-spin stroke-slate-200 text-slate-900 dark:stroke-slate-800 dark:text-sky-400" />
        </div>
      )}
    </div>
  )
