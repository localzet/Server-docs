                    ...
                    <Dialog onClose={close} className="fixed inset-0 z-50 lg:hidden">
                        ...
                        <Dialog.Panel>
                            ...
                            >
                                <motion.div
                                    layoutScroll
                                    className="fixed bottom-0 left-0 top-14 w-full overflow-y-auto bg-white px-4 pb-4 pt-6 shadow-lg shadow-slate-900/10 ring-1 ring-slate-900/7.5 dark:bg-slate-900 dark:ring-slate-800 min-[416px]:max-w-sm sm:px-6 sm:pb-10"
                                >
                                    <Navigation/>
                                </motion.div>
                            </Transition.Child>
