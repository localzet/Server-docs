...
Откройте браузер Chrome, нажмите F12 для открытия консоли разработчика, на вкладке Console, выполните следующий код (или поместите этот код в HTML-страницу и запустите его с помощью JavaScript):
